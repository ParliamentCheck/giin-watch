...
FORMER_MEMBERS = [
    ...
    # --- 請願紹介実績で元議員と確認（2026-04-06 追加） ---
    # 衆議院（session 219 まで発言確認 → 現ロスター不在 = 前議員）
    {"name": "下条みつ",   "house": "衆議院", "party": "立憲民主党"},
    {"name": "升田世喜男", "house": "衆議院", "party": "立憲民主党"},
    {"name": "市來伴子",   "house": "衆議院", "party": "立憲民主党"},
    {"name": "松田功",     "house": "衆議院", "party": "立憲民主党"},
    {"name": "猪口幸子",   "house": "衆議院", "party": "日本維新の会"},
    {"name": "白石洋一",   "house": "衆議院", "party": "立憲民主党"},
    {"name": "眞野哲",     "house": "衆議院", "party": "立憲民主党"},
    {"name": "福田淳太",   "house": "衆議院", "party": "立憲民主党"},
    {"name": "竹内譲",     "house": "衆議院", "party": "公明党"},
    {"name": "西川厚志",   "house": "衆議院", "party": "立憲民主党"},
    {"name": "赤嶺政賢",   "house": "衆議院", "party": "共産党"},
    {"name": "辻英之",     "house": "衆議院", "party": "立憲民主党"},
    {"name": "鈴木岳幸",   "house": "衆議院", "party": "立憲民主党"},
    {"name": "長谷川嘉一", "house": "衆議院", "party": "立憲民主党"},
    {"name": "高松智之",   "house": "衆議院", "party": "立憲民主党"},
    {"name": "高橋永",     "house": "衆議院", "party": "立憲民主党"},
    {"name": "齋藤裕喜",   "house": "衆議院", "party": "立憲民主党"},
    {"name": "山本博司",   "house": "衆議院", "party": "公明党"},
    {"name": "林佑美",     "house": "衆議院", "party": "日本維新の会"},
    {"name": "柳沢剛",     "house": "衆議院", "party": "立憲民主党"},
    {"name": "波多野翼",   "house": "衆議院", "party": "立憲民主党"},
    # 参議院（session 217 最終 → 2025年7月参院選で退任）
    {"name": "三宅伸吾",   "house": "参議院", "party": "自民党"},
    {"name": "三浦靖",     "house": "参議院", "party": "自民党"},
    {"name": "伊藤岳",     "house": "参議院", "party": "共産党"},
    {"name": "佐々木さやか", "house": "参議院", "party": "公明党"},
    {"name": "佐藤信秋",   "house": "参議院", "party": "自民党"},
    {"name": "佐藤正久",   "house": "参議院", "party": "自民党"},
    {"name": "吉川ゆうみ", "house": "参議院", "party": "自民党"},
    {"name": "堂故茂",     "house": "参議院", "party": "自民党"},
    {"name": "塩田博昭",   "house": "参議院", "party": "公明党"},
    {"name": "安江伸夫",   "house": "参議院", "party": "公明党"},
    {"name": "宮口治子",   "house": "参議院", "party": "無所属"},
    {"name": "宮崎雅夫",   "house": "参議院", "party": "自民党"},
    {"name": "山下芳生",   "house": "参議院", "party": "共産党"},
    {"name": "山口和之",   "house": "参議院", "party": "日本維新の会"},
    {"name": "新妻秀規",   "house": "参議院", "party": "公明党"},
    {"name": "森屋宏",     "house": "参議院", "party": "自民党"},
    {"name": "滝沢求",     "house": "参議院", "party": "自民党"},
    {"name": "矢倉克夫",   "house": "参議院", "party": "公明党"},
    {"name": "石井正弘",   "house": "参議院", "party": "自民党"},
    {"name": "羽生田俊",   "house": "参議院", "party": "自民党"},
    {"name": "若松謙維",   "house": "参議院", "party": "公明党"},
    {"name": "藤巻健史",   "house": "参議院", "party": "日本維新の会"},
    {"name": "衛藤晟一",   "house": "参議院", "party": "自民党"},
    {"name": "豊田俊郎",   "house": "参議院", "party": "自民党"},
    {"name": "赤池誠章",   "house": "参議院", "party": "自民党"},
    {"name": "長峯誠",     "house": "参議院", "party": "自民党"},
]
