  ...
  return (
    <div style={{ minHeight: "100vh", background: "#030d0d", color: "#e8f5f5",
      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        <div style={{ background: "#071a1a", border: "1px solid #0d2828", borderRadius: 16,
          padding: 28, fontSize: 13, color: "#90c8c8", lineHeight: 2 }}>

          <h2 style={{ fontSize: 16, fontWeight: 700, color: "#e8f5f5", marginBottom: 12 }}>第1条（目的）</h2>
          ...
          <h2 style={{ fontSize: 16, fontWeight: 700, color: "#e8f5f5", marginBottom: 12 }}>第2条（参照範囲）</h2>
          <p style={{ marginBottom: 20 }}>
          ...
          <h2 style={{ fontSize: 16, fontWeight: 700, color: "#e8f5f5", marginBottom: 12 }}>第3条（禁止行為）</h2>
          ...
          <h2 style={{ fontSize: 16, fontWeight: 700, color: "#e8f5f5", marginBottom: 12 }}>第4条（免責事項）</h2>
          <p style={{ marginBottom: 20 }}>
          ...
          <h2 style={{ fontSize: 16, fontWeight: 700, color: "#e8f5f5", marginBottom: 12 }}>第5条（データの訂正）</h2>
          <p style={{ marginBottom: 20 }}>
          ...
          <h2 style={{ fontSize: 16, fontWeight: 700, color: "#e8f5f5", marginBottom: 12 }}>第6条（規約の変更）</h2>
          <p style={{ marginBottom: 20 }}>
            運営者は、必要と判断した場合、本規約を変更することがあります。
            変更後の規約は当ページに掲載した時点で効力を生じるものとします。
          </p>

          <p style={{ color: "#4a7a7a", fontSize: 11, marginTop: 24 }}>
            制定日：2026年2月27日
          </p>
        </div>
      </div>
